...
class _AdminSignInState extends State<AdminSignIn> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : StreamBuilder<UserDataAdmin>(
      ...
      builder: (context, snapshot){
        ...
        admin = snapshot.data;
          ...
          DatabaseServiceAdmin(uid: adminID).updateAdminData("SUTT_admin", "1234567890");
        }
        return Scaffold(
          body: Container(
                        ...
                        MaterialButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              ...
                              dynamic response = await _auth.adminLogin(nameController.text, passController.text, admin);
                              if(response == null){
                                setState((){
                                  loading = false;
